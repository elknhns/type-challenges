...
type MyAwaited<T extends { then: (onfulfilled: (arg: any) => any) => any }> = T extends { then: (onfulfilled: (arg: infer U) => any) => any } ? U extends { then: (onfulfilled: (arg: any) => any) => any } ? MyAwaited<U> : U : never
